...
function App() {
  ...
  const demoPath = `${import.meta.env.BASE_URL}demo`
    ...
    <main id="top">
      <nav className="top-nav">
        ...
        <div className={`nav-links ${menuOpen ? 'open' : ''}`}>
          ...
          <a className="nav-cta" href={demoPath}>Try live demo <ArrowRight size={15} /></a>
        </div>
      ...
      <section className="hero" id="product">
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <a className="solid-button" href={demoPath}>Try live demo <ArrowRight size={17} /></a>
